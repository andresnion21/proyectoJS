class guitarra {
  ...
  descontarUnidad(unidad) {
    if (this.cantidad > unidad) this.cantidad = this.cantidad - unidad;
  }
}

const guitarra1 = new guitarra("Ibanez", "RG", 2015, 1200, 1, true);
...
const guitarra4 = new guitarra("Musicman", "Majesty", 2020, 2000, 1, true);
const guitarra5 = new guitarra("PRS", "SE", 2024, 1500, 1, true);
const guitarra6 = new guitarra("Fender", "Telecaster", 1986, 2800, 1, true);

const guitarras = [guitarra1, guitarra2, guitarra3, guitarra4];

document.getElementById("gtr1").addEventListener("click", () => {
  mostrarInfoGuitarra(guitarra1);
  agregarGuitarraSeleccionada(guitarra1);
  deshabilitarBoton("gtr1");
  Toastify({
...
document.getElementById("gtr2").addEventListener("click", () => {
  mostrarInfoGuitarra(guitarra2);
  agregarGuitarraSeleccionada(guitarra2);
  deshabilitarBoton("gtr2");
  Toastify({
...
document.getElementById("gtr3").addEventListener("click", () => {
  mostrarInfoGuitarra(guitarra3);
  agregarGuitarraSeleccionada(guitarra3);
  deshabilitarBoton("gtr3");
  Toastify({
...
document.getElementById("gtr4").addEventListener("click", () => {
  mostrarInfoGuitarra(guitarra4);
  agregarGuitarraSeleccionada(guitarra4);
  deshabilitarBoton("gtr4");
  Toastify({
...
document.getElementById("gtr5").addEventListener("click", () => {
  mostrarInfoGuitarra(guitarra5);
  agregarGuitarraSeleccionada(guitarra5);
  deshabilitarBoton("gtr5");
  Toastify({
...
document.getElementById("gtr6").addEventListener("click", () => {
  mostrarInfoGuitarra(guitarra6);
  agregarGuitarraSeleccionada(guitarra6);
  deshabilitarBoton("gtr6");
  Toastify({
...
function mostrarInfoGuitarra(guitarra) {
  const mensaje = `${guitarra.marca}, ${guitarra.modelo}, ${
    guitarra.año
  } - ${guitarra.precioConIva()}`;
  console.log(mensaje);
} 

function agregarGuitarraSeleccionada(guitarra) {
  const index = guitarrasSeleccionadas.findIndex(
    (g) => g.marca === guitarra.marca && g.modelo === guitarra.modelo
  );

  if (index === -1) {
    guitarrasSeleccionadas.push(guitarra);
    console.log(
      `Guitarra ${guitarra.marca} ${guitarra.modelo} agregada a la lista de seleccionadas.`
    );
  } else {
    console.log(
      `La guitarra ${guitarra.marca} ${guitarra.modelo} ya está en la lista de seleccionadas.`
    );
  }
...
function agregarAlCarrito(guitarrasSeleccionadas) {
  let guitarrasLocalStorage =
    JSON.parse(localStorage.getItem("guitarrasSeleccionadas")) || [];

  guitarrasSeleccionadas.forEach((guitarra) => {
    const index = guitarrasLocalStorage.findIndex(
      (g) => g.marca === guitarra.marca && g.modelo === guitarra.modelo
    );
  ...
  localStorage.setItem(
    "guitarrasSeleccionadas",
    JSON.stringify(guitarrasLocalStorage)
  );
}
